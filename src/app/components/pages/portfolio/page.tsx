...
const PortfolioPage: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative">
      <LogoIcon />
      <div className="container w-[80%] sm:w-full z-10 items-center justify-center bg-opacity-60 gap-4 overflow-hidden rounded-lg border bg-background px-20 md:shadow-xl">
